...
public class PQHeapTester {
    public static void main( String[] args ) {
        ...
        ppq.add( new KeyValuePair<Integer,Float>( Integer.valueOf(1), Float.valueOf(2.0f)) );
        ppq.add( new KeyValuePair<Integer,Float>( Integer.valueOf(3), Float.valueOf(1.0f) ) );
        ppq.add( new KeyValuePair<Integer,Float>( Integer.valueOf(4), Float.valueOf(0.0f) ) );
